...
import static Server.server.a1;
import javax.swing.*;
...
public class client implements ActionListener {
    ...
    client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Server/icons/2.png"));
        ...
        JLabel l3 = new JLabel("Lionel Messi");
        l3.setFont(new Font("SAN_SERIF", Font.BOLD, 18));
        l3.setForeground(Color.WHITE);
        l3.setBounds(110, 15, 125, 20);
        p1.add(l3);
    ...
    public void actionPerformed(ActionEvent ae){
     ...
     public void sendTextToFile(String msg) throws IOException{
        
        try{
            
            FileWriter f = new FileWriter("chat.txt");
            PrintWriter p = new PrintWriter(new BufferedWriter(f));
            p.println("Lionel Messi: " +msg);
